...
function ColorPickerHueSlider(props: ColorPickerHueSliderProps) {
  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="border-neutral-900/50 bg-white focus-visible:ring-neutral-950 block size-4 rounded-full border border-neutral-200 shadow transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-50/50 dark:bg-neutral-950 dark:focus-visible:ring-neutral-300 dark:border-neutral-800" />
    </SliderPrimitive.Root>
  )
}
...
function ColorPickerSwatch(props: ColorPickerSwatchProps) {
  ...
  return (
    <SwatchPrimitive
      ...
      {...swatchProps}
      className={cn(
        "box-border size-8 rounded-sm border border-neutral-200 shadow-sm dark:border-neutral-800",
