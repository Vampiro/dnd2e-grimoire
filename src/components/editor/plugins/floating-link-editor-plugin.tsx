  ...
  return (
    ...
    >
      {!isLink ? null : isLinkEditMode ? (
        <div className="flex items-center space-x-2 rounded-md border border-neutral-200 p-1 pl-2 dark:border-neutral-800">
          <Input
            ref={inputRef}
            value={editedLinkUrl}
        ...
        <div className="flex items-center justify-between rounded-md border border-neutral-200 p-1 pl-2 dark:border-neutral-800">
          <a
